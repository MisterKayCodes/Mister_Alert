...
# Force project root to be first in path to avoid any shadowing
...
async def test_full_cycle():
    ...
    async with AsyncSessionLocal() as session:
        ...
        await trade_repo.create_trade(user_id=user.id, symbol="ETHUSD", entry_price=2000, take_profit=2500, stop_loss=1500, position_size=1.0, direction="LONG")
