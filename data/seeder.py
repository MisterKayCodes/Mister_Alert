...
DEFAULT_SETTINGS = [
    ...
    ("price_credits_10", "500", "Price for 10 credits (in user's currency)"),
    ("price_premium_monthly", "2000", "Monthly subscription price"),
    ("price_premium_yearly", "18000", "Yearly subscription price"),
    ("subscription_footer",
